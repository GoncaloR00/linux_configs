# Enable Powerlevel10k instant prompt. Should stay close to the top of ~/linux_configs/terminal/zsh/.zshrc.
# Initialization code that may require console input (password prompts, [y/n]
# confirmations, etc.) must go above this block; everything else may go below.
if [[ -r "$HOME/linux_configs/terminal/zsh/ohmyzsh/custom/themes/powerlevel10k/custom_setup/p10k-instant-prompt-gribeiro.zsh" ]]; then
  source "$HOME/linux_configs/terminal/zsh/ohmyzsh/custom/themes/powerlevel10k/custom_setup/p10k-instant-prompt-gribeiro.zsh"
fi
